...
# the button combo is held.
  ...
  b activation                             # /
pressed:
  andi. r0, r10, pressedBit                # \ if Select + A is pressed
...
respawn:
  ...
  lis r3, objectSpawns@h                   # | (in particular, to respawn energy pickups)
...
loopRespawnObjects:                        # |
  ...
  li r12, 0x0008                           # > Set game mode to respawn at checkpoint
